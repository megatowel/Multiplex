...
stage('Build')
{
    node(params.BuildSlaveTag)
    {
        ...
        {   
            ...
            runCommand( 'cmake -B_build --target MTMultiplex' )
            ...
            runCommand( 'cmake -B_build_win --target MTMultiplex -DCMAKE_TOOLCHAIN_FILE=./cmake/Toolchain-cross-mingw32-linux.cmake' )
